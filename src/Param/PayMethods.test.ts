...
describe('PayMethods', () => {
  it('should create a PayMethods instance correctly with multiple methods', () => {
    const payMethods = new PayMethods(PayMethodEnum.CARD, PayMethodEnum.MASTERPASS, PayMethodEnum.GOOGLE_PAY);

    expect(payMethods.getValue()).toEqual([PayMethodEnum.CARD, PayMethodEnum.MASTERPASS, PayMethodEnum.GOOGLE_PAY]);
