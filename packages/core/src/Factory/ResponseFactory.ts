...
export class ResponseFactory {
	...
	create(
		params: Partial<Record<Param | ResponseEnum, string>>,
	): ResponseInterface {
		const clonedParams: Partial<Record<Param | ResponseEnum, string>> = {
			...params,
		};
	...
	private getStringValue<T = Record<Param | ResponseEnum, string>>(
		name: keyof T,
		params: Partial<T>,
		defaultValue = "",
	) {
	...
	private getIntValue<T = Record<Param | ResponseEnum, string>>(
		name: keyof T,
		params: Partial<T>,
		defaultValue = 0,
	) {
