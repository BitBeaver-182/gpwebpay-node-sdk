...
import type { ConfigParams, GatewayConfig } from "./ConfigFactoryInteface";
import type { PaymentConfigFactory } from "./PaymentConfigFactory";
...
export class ConfigFactory {
	...
	public create(params: ConfigParams, defaultGateway = "default"): Config {
	...
	private processParams(
		params: Record<string, GatewayConfig>,
		config: Config,
	): void {
